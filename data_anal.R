...
first_stage@names[2] <- "Black/White Dissimilarity Index"
first_stage@names[3] <- "Black/White Exposure Index"
...
a@names[2] <- "Black/White Dissimilarity Index (IV)"
a@names[3] <- "Black/White Exposure Index (IV)"
a@names[4] <- "Black/White Dissimilarity Index (OLS)"
a@names[5] <- "Black/White Exposure Index (OLS)"
...
a@table_dataframe[17,1] <- "Black/White Exposure Index"
a@table_dataframe[19,1] <- "Black/White Exposure Index*Average black incarceration"
